...
import os
from financials.tools.dictionary import ACCOUNT_NAME_DICTIONARY, BS_ACCOUNTS, IS_ACCOUNTS, DART_APIS, MODIFIED_REPORT
from financials.tools.dc_tools import log_print, null_checker, nth_quarter_before, generate_krx_data, merge_update, save_main_financial_reports_db, get_main_financial_reports_db
from financials.tools.dc_tools import create_plots_from_plot_gen_control
import pandas as pd
import numpy as np
...
if __name__ == '__main__': 
    ...
    log_file = os.path.join(cd_, 'log/fr_data_collect.log')
